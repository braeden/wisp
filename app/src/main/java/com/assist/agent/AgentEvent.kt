...
sealed interface AgentEvent {
    ...
    data class Started(val sessionId: Long, val intent: String) : AgentEvent
    ...
    data class ToolCallStarted(val id: String, val name: String, val argsJson: String) : AgentEvent
     ...
     */
    data class AwaitingConfirmation(val question: String, val category: String) : AgentEvent
    ...
    data class Speaking(val text: String) : AgentEvent
